...
if OPERATION == 'sequential':    
    ...
    fn_text = '/kpoint_{}_seqfit_nband={}_ofs={}_{}'.format(DATASOURCE, NBAND, argofs, VARYING_INIT)
    ...
    if __name__ == '__main__':
        ...
        fn_text = '/kpoint_{}_parafit_nband={}_ofs={}_{}'.format(DATASOURCE, NBAND, argofs, VARYING_INIT)
        kfit.save_data(fdir=out_dir, fname=fn_text + '.h5')
        if PICKLE:
            pf.utils.pickle_obj(out_dir + fn_text + '.pickle', kfit.fitres)
