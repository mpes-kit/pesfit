...
EOFS="0.32 0.36 0.40 0.44 0.48 0.52 0.56"
...
for EOF in $EOFS
do
    SHFTS="0.26 0.26 0.26 0.1 0.48 $EOF 0 0"
...
EOFS="0.16 0.20 0.24 0.28 0.32"
echo "Tuning initial conditions for reconstructing band #7 ..."
for EOF in $EOFS
do
    SHFTS="0.26 0.26 0.26 0.1 0.48 0.52 $EOF 0"
...
for EOF in $EOFS
do
    SHFTS="0.26 0.26 0.26 0.1 0.48 0.52 0.28 $EOF"
